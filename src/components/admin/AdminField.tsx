...
export function Field({ label, required, children }: FieldProps) {
  return (
    <div className="flex flex-col gap-1.5">
      <label className="text-[10px] font-bold tracking-widest" style={{ color:"rgba(255,255,255,0.4)" }}>
...
const base: React.CSSProperties = {
  ...
  borderRadius:10, color:"white", fontSize:13, padding:"10px 14px", width:"100%", outline:"none",
};
  ...
  return (
    <label className="flex items-center gap-3 cursor-pointer">
      <div onClick={()=>onChange(!checked)}
           ...
           style={{ width:36, height:20, background: checked?"var(--orange)":"rgba(255,255,255,0.15)" }}>

  ...
  return (
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-xs mt-0.5" style={{ color:"rgba(255,255,255,0.3)" }}>Edit hero headlines, subtext, and publish status for each page</p>
      </div>
              ...
              <div className="flex items-center gap-3 flex-1 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2 mb-0.5">
                    ...
                    <code className="text-[9px] px-1.5 py-0.5 rounded font-mono" style={{ background:"rgba(255,255,255,0.06)", color:"rgba(255,255,255,0.4)" }}>{p.slug}</code>
                    <button onClick={()=>update({...p,published:!p.published})}
                            ...
                            style={{ background:p.published?"rgba(34,197,94,0.12)":"rgba(255,255,255,0.05)", color:p.published?"#22c55e":"rgba(255,255,255,0.3)" }}>
                      {p.published?<Eye size={8}/>:<EyeOff size={8}/>} {p.published?"Live":"Draft"}
                    </button>
                  </div>
                  <p className="text-[11px] truncate" style={{ color:"rgba(255,255,255,0.35)" }}>{p.heroHeadline}</p>
                  <p className="text-[10px] mt-0.5" style={{ color:"rgba(255,255,255,0.2)" }}>Last edited {p.lastEdited}</p>
                </div>
              </div>
